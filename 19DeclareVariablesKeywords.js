...
let myval; //actually we are creating a contract that ensures the variable will only hold values of that specific type i.e string
...
let myvariable = true; //strongly type defined means that we are actually creating a ccontract that type of this specific variable is of boolean.
...
const value3 = "Hello from const world";
 ...
 */
//Strongly Type
const value5 = "Behaviour of constant"; //string.
const value6 = 34; //number
...
var city = "America"; //strongly  string
