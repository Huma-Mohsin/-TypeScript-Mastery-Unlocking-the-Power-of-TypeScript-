...
let arrstr:string[]=["Huma","Ayesha","Amna","Saima"];
console.log(arrstr);
...
function greet(name:string,...restparam:string[]){
...
function func(a:number,b:number,...rest:number[]){
...
function ArrayConcat(arr1:number[],arr2:number[]){
...
function arrayExpansion(a:number,arr3:number[]){
     let newArray=[a,...arr3];
...
function child(...args:number[]){
    return args;
}

function parent(child:Function){
